module.exports = Game = function(){
	...
	for (var i = 0; i < 2; i++) (function(i){
		var iface = me.interfaces[i],
			opIface = me.interfaces[(i + 1) % 2];
		iface.setOpponent(opIface.player);
		iface.shootingCall = function(){
			return opIface.receiveShot.apply(opIface, arguments);
		};
...
Game.prototype.start = function() {
	this.interfaces.forEach(function(i){
		i.emit("gameStart");
	});
